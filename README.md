...
|------------------|----------------------|
| [![Build Status](https://travis-ci.org/nekromant/aura.svg?branch=master)](https://travis-ci.org/nekromant/aura) |   [![Build Status](http://jenkins.ncrmnt.org/job/Github%20CI/job/aura/badge/icon?ts=1)](https://jenkins.ncrmnt.org/job/Github%20CI/job/aura/)|
