...
function(add_aura_test testname testcommand)
    ...
    set_property(TEST epoll-${testname} PROPERTY ENVIRONMENT ${CTEST_ENVIRONMENT} "AURA_USE_EVENTLOOP=epoll" "AURA_LUA_SCRIPT_PATH=${CMAKE_SOURCE_DIR}/lua")
    set_property(TEST epoll-${testname} PROPERTY TIMEOUT ${AURA_TEST_TIMEOUT})
    if(LIBEVENT_FOUND)
        ADD_TEST(libevent-${testname} ${testcommand} ${ARGN})
        set_property(TEST libevent-${testname} PROPERTY ENVIRONMENT ${CTEST_ENVIRONMENT} "AURA_USE_EVENTLOOP=libevent" "AURA_LUA_SCRIPT_PATH=${CMAKE_SOURCE_DIR}/lua")
        set_property(TEST libevent-${testname} PROPERTY TIMEOUT ${AURA_TEST_TIMEOUT})
    endif()
